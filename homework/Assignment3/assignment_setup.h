...
inline void assignment_setup(Eigen::VectorXd &q, Eigen::VectorXd &qdot) {
    ...
    //load geometric data 
    igl::readMESH("../../../data/homework2/coarse_bunny.mesh",V,T, F);
...
inline void assignment_setup(int argc, char **argv, Eigen::VectorXd &q, Eigen::VectorXd &qdot) {
    ...
    //load geometric data 
    igl::readMESH("../../../data/homework3/coarser_bunny.mesh",V,T, F);
    igl::readOBJ("../../../data/homework3/bunny_skin.obj", V_skin, F_skin);

    if(argc > 1) {
        if(strcmp(argv[1], "arma") == 0) {
            read_tetgen(V,T, "../../../data/homework3/arma_6.node", "../../../data/homework3/arma_6.ele");
            igl::readOBJ("../../../data/homework3/armadillo.obj", V_skin, F_skin);
